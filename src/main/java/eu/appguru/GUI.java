...
public class GUI extends JFrame {
    ...
    public GUI() throws IOException {
        ...
        JComboBox pages_op = new JComboBox(new String[]{"Folder", "Merge"});
        ((JLabel) pages_op.getRenderer()).setHorizontalAlignment(JLabel.RIGHT);
        con.gridx = 0;
        con.gridy = 0;
        options.add(new JLabel("Pages:"), con);
        con.gridx++;
        options.add(pages_op, con);
        ...
        start.addActionListener((ActionEvent ae) -> {
            ...
            if (fix_it) {
                ...
                conf.put("pages", ((String) pages_op.getSelectedItem()).toLowerCase());
