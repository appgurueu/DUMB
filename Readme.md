![DUMB logo](https://raw.githubusercontent.com/appgurueu/DUMB/res/DUMB_256x256.png)
...
[Download the JAR](https://raw.githubusercontent.com/appgurueu/DUMB/build/libs/DUMB-alpha-all.jar) and then execute it using `java -jar DUMB.jar {arguments}`.
